...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param dividerWidth  单位为dp -1代表充满屏幕
     * @param dividerHeight  单位为dp
     */
    public DividerItemDecoration(Context context, @ColorInt int color, @Dimension float dividerWidth, @Dimension float dividerHeight) {
        mDivider = new ColorDrawable(color);
        if(dividerWidth==-1){
            this.dividerWidth= CommonUtils.getScreenResolution()[0];
        }else{
